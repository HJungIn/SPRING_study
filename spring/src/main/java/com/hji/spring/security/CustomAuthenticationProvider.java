...
public class CustomAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        User securityUserDetailsDto = (User) userDetailsService.loadUserByUsername(loginId);
        ...
        if (!bCryptPasswordEncoder().matches(userPassword, securityUserDetailsDto.getPassword())) {
            throw new BadCredentialsException(securityUserDetailsDto.getFullname() + "Invalid password");
        }
